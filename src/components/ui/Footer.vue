<template>
	<footer>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-7">
					<p class="small-txt">© 2021 LLC «ITC» Российская логистическая компания. Все права защищены. <br>
	...
	export default{
		...
		methods:{
			submitForm(){
				...
				axios
				.post('https://itc-log.com/wp-json/contact-form-7/v1/contact-forms/10/feedback', form)
				.then(res => {
					this.load = false
